(function (jQuery) {
    ...
    function changeMode (dark) {
        ...
        if (dark === 'true') {
            ...
            $('h1, h2, h3, h4, h5, h6, p, span, label, button, input, select, textarea').addClass('text-light');
            ...
            $('h1, h2, h3, h4, h5, h6, p, span, label, button, input, select, textarea').removeClass('text-light');
