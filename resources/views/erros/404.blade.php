<html lang="en">
<!-- Mirrored from templates.iqonic.design/posdash/html/backend/pages-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 08:49:21 GMT -->

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Página não encontrada | {{ getConfig('nome_site') ?? env('APP_NAME') }}</title>
            ...
            <div class="row no-gutters height-self-center">
                <div class="col-sm-12 text-center align-self-center">
                    <div class="iq-error position-relative">
                        <img src="{{ pharma('assets/images/error/404.png')}}" class="img-fluid iq-error-img" alt="">
                        ...
                        <a class="btn btn-primary d-inline-flex align-items-center mt-3" href="{{ route('home') }}"><i
                                class="ri-home-4-line"></i>Voltar ao inicio</a>
                    </div>
                </div>
            </div>
        </div>
