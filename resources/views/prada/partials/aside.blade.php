    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="">
                    <a href="{{ route('home') }}" onclick="carregarConteudo('{{ route('main') }}', event, true);" class="svg-icon">
                ...
                <li class=" ">
                    ...
                    <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="#" onclick="carregarConteudo('{{ route('produto') }}', event);">
                                <i class="las la-minus"></i><span>Produto</span>
                            </a>
                        </li>
                        <li class="">
                ...
                <li class=" ">
                    <a href="{{ route('categoria') }}" onclick="carregarConteudo('{{ route('categoria') }}', event);" class="collapsed" data-toggle="collapse" aria-expanded="false">
