                    ...
                    <div class="row">
                        @forelse($documents as $doc)
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                                <div class="card h-100 doc-card smart-card" data-type="{{ strtolower($doc->file_extension) }}"
                                    ...
                                    <div class="card-body text-center position-relative">
                                        ...
                                        <h6 class="card-title smart-title" title="{{ $doc->name }}">
                                            {{ Str::limit($doc->name, 30) }}</h6>
                                        <p class="card-text">
                                            <small class="text-muted ai-meta">{{ $doc->formatted_file_size }} •
                                        ...
                                        <div class="btn-group smart-actions" role="group">
                                            <button class="btn btn-sm btn-primary btn-preview smart-btn"
                                                data-url="{{ route('documents.preview', $doc) }}" data-bs-toggle="modal"
                                                data-bs-target="#previewModal">
                                                <i class="fa fa-eye"></i>
                                                <span class="btn-tooltip">Visualizar</span>
                                            </button>
                                            <a href="{{ route('documents.download', $doc) }}"
                                                class="btn btn-sm btn-success smart-btn">
                    ...
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @forelse($documents as $doc)
                                        <tr data-type="{{ strtolower($doc->file_extension) }}"
                                            data-name="{{ strtolower($doc->name) }}">
                                            <td>
                                            ...
                                            <td><span
                                                    class="badge bg-light text-dark">{{ strtoupper($doc->file_extension) }}</span>
                                            </td>
