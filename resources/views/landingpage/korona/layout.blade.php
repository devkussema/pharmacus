...
<html>
    <head>
        <meta charset="utf-8">
        <title>Página Inicial - Pharmatina</title>
        <!-- Stylesheets -->
        ...
        <link rel="icon" href="{{ asset('landingpage/images/favicon.png') }}" type="image/x-icon">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
        <!--[if lt IE 9]><script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.js"></script><![endif]-->
        <!--[if lt IE 9]><script src="{{ asset('landingpage/js/respond.js') }}"></script><![endif]-->
    </head>
    <body>
    ...
    <script src="{{ asset('landingpage/js/jquery.fancybox.js') }}"></script>
    <script src="{{ asset('landingpage/js/appear.js') }}"></script>
    <script src="{{ asset('landingpage/js/owl.js') }}"></script>
