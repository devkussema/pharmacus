                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-info-light">
                                        <img src="{{ asset('prepharma/images/product/1.png') }}" class="img-fluid"
                                            alt="image">
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-danger-light">
                                        <img src="{{ asset('prepharma/images/product/2.png') }}" class="img-fluid"
                                            alt="image">
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-success-light">
                                        <img src="{{ asset('prepharma/images/product/3.png') }}" class="img-fluid"
                                            alt="image">
                                    </div>
                                    <div>
