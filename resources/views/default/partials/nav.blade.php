        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('home') }}" class="header-logo">
                    <img src="{{ asset('prepharma/images/black__logo.png') }}" class="img-fluid rounded-normal" alt="logo">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        @endif
                        @if (vPerm('produtos', ['cadastrar']) or @Auth::user()->isFarmacia)
                            <li>
                                <a href="#" title="Adicionar Produto"
                                    class="btn add-btn shadow-none d-block d-md-block" data-toggle="modal"
                                    data-target="#modalAddProdutoEstoque" title="Adicionar Cargo">
                        ...
                        @endif
                        @if (auth()->user()->isFarmacia or vPerm('cargo', ['cadastrar']))
                            <li>
                                <a href="#" title="Adicionar Cargo"
                                    class="btn add-btn shadow-none d-block d-md-block" data-toggle="modal"
                                    data-target="#addCargo" title="Adicionar Cargo">
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ asset('prepharma/images/user/1.png')}}" class="img-fluid rounded" alt="user">
                            </a>
                            <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <div class="card shadow-none m-0">
                                    <div class="card-body p-0 text-center">
                                        <div class="media-body profile-detail text-center">
                                            <img src="{{ asset('prepharma/images/page-img/profile-bg.jpg')}}" alt="profile-bg"
                                                class="rounded-top img-fluid mb-4">
                                            <img src="{{ asset('prepharma/images/user/1.png')}}" alt="profile-img"
