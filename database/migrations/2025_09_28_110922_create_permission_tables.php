...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable($tableNames['model_has_permissions'])) {
            ...
            Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $pivotPermission, $teams, $modelMorphKey) {
            $table->unsignedBigInteger($pivotPermission);

            $table->string('model_type');
            // Use configured morph key (supports UUIDs)
        ...
        if (!Schema::hasTable($tableNames['model_has_roles'])) {
            ...
            Schema::create($tableNames['model_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames, $pivotRole, $teams, $modelMorphKey) {
