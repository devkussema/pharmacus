...
<script src="{{ assetr('assets/js/bootstrap.bundle.min.js') }}"
    type="be6558ccd95e077c3366a663-text/javascript"></script>
<script src="{{ assetr('assets/js/feather.min.js') }}" type="be6558ccd95e077c3366a663-text/javascript"></script>
...
<script src="{{ assetr('assets/plugins/datatables/jquery.dataTables.min.js') }}"
    type="be6558ccd95e077c3366a663-text/javascript"></script>
<script src="{{ assetr('assets/plugins/datatables/datatables.min.js') }}"
    type="be6558ccd95e077c3366a663-text/javascript"></script>
<script src="{{ assetr('assets/js/jquery.waypoints.js') }}" type="be6558ccd95e077c3366a663-text/javascript"></script>
<script src="{{ assetr('assets/js/jquery.counterup.min.js') }}"
    type="be6558ccd95e077c3366a663-text/javascript"></script>
<script src="{{ assetr('assets/plugins/apexchart/apexcharts.min.js') }}"
    type="be6558ccd95e077c3366a663-text/javascript"></script>
<script src="{{ assetr('assets/plugins/apexchart/chart-data.js') }}"
    type="be6558ccd95e077c3366a663-text/javascript"></script>
